...
% --- Authors ---
% NeurIPS Evaluations & Datasets Track double-blind submission.
% Real author block lives in the private working repo and will be
% restored at acceptance.
...
HuggingFace dataset
(\url{https://huggingface.co/datasets/mysteriousauthor/spikeprophecy-steinmetz}).
...
\begin{itemize}[nosep, leftmargin=*]
  \item \textbf{Data:} Processed 50\,ms-binned spike-count matrices
    (NPY + session metadata JSON).  The Steinmetz processed tensors
    are released as a HuggingFace dataset
    (\url{https://huggingface.co/datasets/mysteriousauthor/spikeprophecy-steinmetz},
    CC-BY-4.0); the IBL processed tensors are deterministic outputs
    of our preprocessing pipeline applied to the public IBL ONE
    API and will be released alongside the Mamba combined-105
    teacher checkpoint at acceptance.  Source recordings remain at
    their original public homes: Steinmetz at Figshare
